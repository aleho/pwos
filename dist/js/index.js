...
$export($export.S + $export.F * !_dereq_(55)(function (iter) {  }), 'Array', {
...
function () {
  ...
  _createClass(Db, [{
    ...
    value:
    /*#__PURE__*/
    regeneratorRuntime.mark(function filter(_filter) {
      var fTitle, fUrl, i, site;
      return regeneratorRuntime.wrap(function filter$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _filter = _filter || {};
              fTitle = _filter.title ? new RegExp(_filter.title, 'i') : null;
              fUrl = _filter.url ? new RegExp(_filter.url, 'i') : null;
              i = 0;
            ...
            case 4:
              ...
              if (!(fTitle && (!site.title || !site.title.match(fTitle)))) {
                _context.next = 9;
                break;
              }
            ...
            case 9:
              if (!(fUrl && (!site.url || !site.url.match(fUrl)))) {
                _context.next = 11;
                break;
              }
...
function (_React$PureComponent) {
  ...
  _createClass(ScrollMonitor, [{
    ...
    value: function render() {
      ...
      }, "More entries available. Scroll to load."), React.createElement("div", {
        role: "alert",
...
function (_React$PureComponent) {
  ...
  function Filter() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Filter.__proto__ || Object.getPrototypeOf(Filter)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "handleFilter", {
      ...
      value: function value(event) {
        ...
        if (!_this.props.attr || val.length < 2 && val.length != 0) {
          return;
        }

        var filter = {};
        filter[_this.props.attr] = val;
  ...
  _createClass(Filter, [{
    ...
    value: function render() {
      ...
      var icon = this.props.icon ? React.createElement("i", {
        "class": 'fas fa-fw ' + this.props.icon
      }) : '';
      return React.createElement("th", {
        ...
        "class": "col-md col-md-auto mr-md-2"
      }, icon, label), React.createElement("div", {
        "class": "col col-xl-7"
      }, React.createElement("input", {
        type: "search",
        "class": "filter form-control form-control-sm",
        placeholder: "filter",
...
function (_React$PureComponent) {
  ...
  _createClass(Header, [{
    key: "render",
    value: function render() {
      return React.createElement("thead", null, React.createElement("tr", null, React.createElement(Filter, {
        attr: "title",
        label: "Site",
        ...
        "class": "fas fa-fw fa-step-backward",
        title: "min length"
      })), React.createElement("th", {
        scope: "col",
        "class": "attr"
      }, React.createElement("i", {
        "class": "fas fa-fw fa-step-forward",
        title: "max length"
      })), React.createElement("th", {
        scope: "col",
        "class": "attr"
      }, React.createElement("span", {
        title: "alphabetical letters"
      }, "A\u2013Z")), React.createElement("th", {
        scope: "col",
        "class": "attr"
      }, React.createElement("span", {
        title: "digits"
      }, "0\u20139")), React.createElement("th", {
        scope: "col",
        "class": "attr"
      }, React.createElement("span", {
        title: "spaces"
      }, "__")), React.createElement("th", {
        scope: "col",
        "class": "attr"
      }, React.createElement("span", {
      ...
      if (this.props.value !== false && this.props.value !== undefined) {
        if (this.props.value === 'onchange') {
          icon = React.createElement("i", {
            "class": "far fa-fw fa-dot-circle text-muted attr-onchange"
          });
        }
      } else {
        icon = React.createElement("i", {
          "class": "far fa-fw fa-times-circle text-danger attr-false"
        });
      }

      return React.createElement("td", {
        "class": 'attr ' + this.props.name
      }, icon);
    }
  }]);
...
function (_React$PureComponent) {
  ...
  function Row(props) {
    ...
    if (props.scoreplus) {
      _this.shameScore += props.scoreplus;
    }
  ...
  _createClass(Row, [{
    ...
    value: function isDelayed() {
      return (!this.state || !this.state.visible) && this.props.animate === true && this.props.delay > 0;
    }
  }, {
    ...
    value: function render() {
      ...
      return React.createElement("tr", {
        ...
        "class": "title"
      }, this.props.title), React.createElement("td", null, React.createElement("a", {
        href: this.props.url,
        "class": "url d-none d-md-block text-truncate",
        target: "_blank"
      }, displayUrl), React.createElement("a", {
        href: "#",
        "class": "url d-inline d-md-none",
        target: "_blank"
      }, React.createElement("i", {
    ...
    value: function render() {
      ...
      var rows = this.props.sites.map(function (site, index) {
        return React.createElement(Row, {
          ...
          pw: site.pw,
          animate: true,
          delay: index % _this.props.delayMod * 30
        });
      });
...
function (_React$Component) {
  ...
  function App() {
    ...
    Object.defineProperty(_assertThisInitialized(_this), "getResults", {
      ...
      value: function value(filter) {
        ...
        _this.results = _this.db.filter(_this.filter || null);
  ...
  _createClass(App, [{
    ...
    value: function addResults() {
      ...
      var sites = this.state.sites.slice();
